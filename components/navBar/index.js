...
var NavBar = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(NavBar, [{
    ...
    value: function _createData() {
      ...
      var _props = this.__props,
          ...
          leftStyle = _props.leftStyle;

      var anonymousState__temp = (0, _index.internal_inline_style)(style);
      var anonymousState__temp2 = (0, _index.internal_inline_style)(leftStyle);
      var anonymousState__temp3 = (0, _index.internal_inline_style)(titleStyle);
  ...
  return NavBar;
}(_index.Component), _class.$$events = [], _class.$$componentPath = "components/navBar/index", _temp2);
